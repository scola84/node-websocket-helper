...
class Message {
  ...
  decode(connection) {
    ...
    return this.filters
      .reduce((promise, filter) => {
        return promise.then(() => filter.get().decode(this, connection));
  ...
  encode(connection) {
    ...
    return this.filters
      ...
      .reverse()
      .reduce((promise, filter) => {
        return promise.then(() => filter.get().encode(this, connection));
      }, Promise.resolve(this));
  }

  clone() {
    return new Message(this.filters)
